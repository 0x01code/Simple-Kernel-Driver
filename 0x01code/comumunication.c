...
NTSTATUS CreateCall(PDEVICE_OBJECT DeviceObject, PIRP Irp)
{
	...
	DebugMessage("CreateCall was called, conntion enstablished \n");
...
NTSTATUS IoControl(PDEVICE_OBJECT DeviceObject, PIRP Irp)
{
	...
	if (ControlCode == IO_GET_MODULEADDRESS)
	{
		PULONG OutPut = (PULONG)Irp->AssociatedIrp.SystemBuffer;
		*OutPut = ModuleBaseAddress;
	...
	else if (ControlCode == IO_PROCESSID_REQUEST)
	{
		PULONG OutPut = (PULONG)Irp->AssociatedIrp.SystemBuffer;
		*OutPut = ProcessID;
